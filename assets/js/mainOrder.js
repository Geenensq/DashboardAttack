...
function addRowProduct($id) {
    ...
    row.id = "ligne" + product; /// Pour chaques ligne on lui affecte un id "ligne" + la variable produit
        ...
        cell9.innerHTML = '<p onClick="deleteRow(' + produit + ')" style="font-size:1.5em;" class="glyphicon glyphicon-remove" aria-hidden="true"></p>';
