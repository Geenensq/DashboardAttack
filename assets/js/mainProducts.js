  	...
  	columnDefs: [

  		{
  			...
  			render: function (data, full) {
  				return '<button type="button" onclick="editGroupsProductsModal(' + data[0] + ')" class="btn btn-info btn-fill" data-toggle="modal" data-target="#modal_update_groups_products">Edition </button>'
  			}
  		},
  		{
  			"targets": 4,
  			render: function (data, full) {
  				return '<a id="btn_state" onclick="ajaxChangeStatus(' + data[0] + ',' + '\'' + "changeStatusGroupsProducts.html" + '\'' + ',' + '\'' + "#tab_groups_products" + '\'' + ')' + '"' + ' class="btn btn-danger btn-fill"><i class="fa fa-edit"></a>'
  			}
  		},
  		{
  			"targets": 5,
  ...
  $('#tab_products').DataTable({
  	...
  	columnDefs: [

  		{
  			"targets": 5,
  			render: function (data, full) {
  				return '<img src="../assets/img/uploaded/' + data[5] + ' " height="80" width="80">'
  			}
  		},
  		{
  			"targets": 7,
  			render: function (data, full) {
  				return '<button type="button" onclick="editProductsModal(' + data[0] + ')" class="btn btn-info btn-fill" data-toggle="modal" data-target="#modal_update_products">Edition </button>'
  			}
  		},
  		{
  			"targets": 8,
  			render: function (data, full) {
  				return '<a id="btn_state" onclick="ajaxChangeStatus(' + data[0] + ',' + '\'' + "changeStatusProducts.html" + '\'' + ',' + '\'' + "#tab_products" + '\'' + ')' + '"' + ' class="btn btn-danger btn-fill"><i class="fa fa-edit"></a>'
  			}
  		},
  		{
  			"targets": 9,
